	...
	void del(node *temp1, int val) {
		...
		if(val > temp1->info) {
			if (temp1->right->info == val) {
				...
				else if (temp1->right->left != NULL && temp1->right->right == NULL) {
					temp = temp1->right;
		...
		if(val < temp1->info) {
			if(temp1->left->info == val) {
				...
				else if (temp1->left->left != NULL && temp1->left->right == NULL) {
					temp = temp1->left;
		...
		if (temp1 == root) {
			if (balance(temp1) == 2) {
		 		if (balance(temp1->left) == 1 || balance(temp1->left) == 0){
		 			changeRoot = true;
		 			clockRotation(temp1);
			cout << "test out" << endl;
		 			return;
				...
				if (balance(temp1->right) == -1 || balance(temp1->left) == 0) {
					changeRoot = true;
					antiClockRotation(temp1);
					return;
				}
		...
		if (balance(temp1->left) == 2){
			if (balance(temp1->left->left) == 1 || balance(temp1->left) == 0) {
				temp = temp1->left;
				clockRotation(temp1);
			}
			else if (balance(temp1->left->left) == -1) {
			...
			else if (balance(temp1->left->right) == -1 || balance(temp1->left) == 0) {
				temp = temp1->left;
				antiClockRotation(temp1);
			}
		}
		...
		if (balance(temp1->right) == 2) {
			if (balance(temp1->right->left) == 1 || balance(temp1->left) == 0) {
				temp = temp1->right;
				clockRotation(temp1);
			}
			if (balance(temp1->right->left) == -1) {
			...
			if (balance(temp1->right->right) == -1 || balance(temp1->left) == 0) {
				temp = temp1->right;
				antiClockRotation(temp1);
			}
			if (balance(temp1->right->right) == 1) {
...
//	cout << "Enter the Value to delete: ";
	...
	//c/out << "Enter the Value to delete: ";
	//cin >> val;
